...
public class SwitchSlf4jTraceQuickfix implements LocalQuickFix {
    @Nls
    @NotNull
    @Override
    public String getName() {
        return "Logging switch using slf4j or log4j or commons-logging trace level";
    }
    ...
    public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor problemDescriptor) {
        SwitchLoggingUtil.doSwitchLogging(project,problemDescriptor, LoggingType.SLF4J, Slf4JLoggingLevel.LOG_TRACE,2);
    }
}
