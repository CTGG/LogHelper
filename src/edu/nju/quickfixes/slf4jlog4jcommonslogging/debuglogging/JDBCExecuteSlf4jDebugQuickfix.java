 ...
 */
public class JDBCExecuteSlf4jDebugQuickfix implements LocalQuickFix {
    @Nls
    @NotNull
    @Override
    public String getName() {
        return "Logging JDBC execute sql using slf4j or log4j or commons-logging debug level";
    }
