...
public class BranchSlf4jErrorQuickfix implements LocalQuickFix {
    @Nls
    @NotNull
    @Override
    public String getName() {
        return "Logging branch using slf4j or log4j or commons-logging error level";
    }
    ...
    public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor problemDescriptor) {
        BranchStatementLoggingUtil.doBranchLogging(project,problemDescriptor, LoggingType.SLF4J, Slf4JLoggingLevel.LOG_ERROR,2);
    }
}
