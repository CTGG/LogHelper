 ...
 */
public class ThreadSlf4jWarnQuickfix implements LocalQuickFix {
    @Nls
    @NotNull
    @Override
    public String getName() {
        return "Logging thread using slf4j or log4j or commons-logging warn level";
    }
    ...
    public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor problemDescriptor) {
        ThreadLoggingUtil.doThreadLogging(project,problemDescriptor, LoggingType.SLF4J, Slf4JLoggingLevel.LOG_WARN,2);
    }
}
