...
public class BranchJavaWarningQuickfix implements LocalQuickFix {
    @Nls
    @NotNull
    @Override
    public String getName() {
        return "Logging branch using java.util.logging warning level";
    }
    ...
    public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor problemDescriptor) {
        BranchStatementLoggingUtil.doBranchLogging(project,problemDescriptor, LoggingType.JAVALOGGING, JavaLoggingLevel.LOG_WARNING,0);
    }
}
